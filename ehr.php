...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        $ehr_id = $stmt->insert_id;
        header("Location: ehr-details.php?ehr_id=$ehr_id");
        exit;
    } else {
        $error = "Error saving patient: " . $conn->error;
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Add Patient - MedConnectPro</title>
...
<body>
    ...
    <div class="container mt-5">
        ...
        <?php endif; ?>
        <form id="ehrForm" method="POST" action="">
            <div class="mb-3">
